...
def run_builder_sanity(gpio_l, gpio_h, bypass):
    """runs the builder for the sanity check, where it will skip the initialization of low and high chain
...
def run_sanity_check():
    ...
    print(f"{VERSION}")
    print(
        f"voltage = {gpio_config_def.voltage:1.2f}, analog = {gpio_config_def.analog}"
    )
    print("===================================================================")
